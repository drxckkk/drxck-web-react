...
// include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
// end include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
// end include: preamble.js
  ...
  /** @type {function(...*):?} */
  function _CheckCollisionPointPoly(
  ) {
  abort('missing function: CheckCollisionPointPoly');
  }
  _CheckCollisionPointPoly.stub = true;

  /** @type {function(...*):?} */
  function _ClosePhysics(
  ) {
  abort('missing function: ClosePhysics');
  }
  _ClosePhysics.stub = true;

  /** @type {function(...*):?} */
  function _CreatePhysicsBodyCircle(
  ) {
  abort('missing function: CreatePhysicsBodyCircle');
  }
  _CreatePhysicsBodyCircle.stub = true;

  /** @type {function(...*):?} */
  function _CreatePhysicsBodyPolygon(
  ) {
  abort('missing function: CreatePhysicsBodyPolygon');
  }
  _CreatePhysicsBodyPolygon.stub = true;

  /** @type {function(...*):?} */
  function _CreatePhysicsBodyRectangle(
  ) {
  abort('missing function: CreatePhysicsBodyRectangle');
  }
  _CreatePhysicsBodyRectangle.stub = true;

  /** @type {function(...*):?} */
  function _DestroyPhysicsBody(
  ) {
  abort('missing function: DestroyPhysicsBody');
  }
  _DestroyPhysicsBody.stub = true;

  /** @type {function(...*):?} */
  function _GenImagePerlinNoise(
  ) {
  abort('missing function: GenImagePerlinNoise');
  }
  _GenImagePerlinNoise.stub = true;

  /** @type {function(...*):?} */
  function _GetPhysicsBodiesCount(
  ) {
  abort('missing function: GetPhysicsBodiesCount');
  }
  _GetPhysicsBodiesCount.stub = true;

  /** @type {function(...*):?} */
  function _GetPhysicsBody(
  ) {
  abort('missing function: GetPhysicsBody');
  }
  _GetPhysicsBody.stub = true;

  /** @type {function(...*):?} */
  function _GetPhysicsShapeType(
  ) {
  abort('missing function: GetPhysicsShapeType');
  }
  _GetPhysicsShapeType.stub = true;

  /** @type {function(...*):?} */
  function _GetPhysicsShapeVertex(
  ) {
  abort('missing function: GetPhysicsShapeVertex');
  }
  _GetPhysicsShapeVertex.stub = true;

  /** @type {function(...*):?} */
  function _GetPhysicsShapeVerticesCount(
  ) {
  abort('missing function: GetPhysicsShapeVerticesCount');
  }
  _GetPhysicsShapeVerticesCount.stub = true;

  /** @type {function(...*):?} */
  function _GuiButton(
  ) {
  abort('missing function: GuiButton');
  }
  _GuiButton.stub = true;

  /** @type {function(...*):?} */
  function _GuiCheckBox(
  ) {
  abort('missing function: GuiCheckBox');
  }
  _GuiCheckBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiCheckIconPixel(
  ) {
  abort('missing function: GuiCheckIconPixel');
  }
  _GuiCheckIconPixel.stub = true;

  /** @type {function(...*):?} */
  function _GuiClearIconPixel(
  ) {
  abort('missing function: GuiClearIconPixel');
  }
  _GuiClearIconPixel.stub = true;

  /** @type {function(...*):?} */
  function _GuiColorBarAlpha(
  ) {
  abort('missing function: GuiColorBarAlpha');
  }
  _GuiColorBarAlpha.stub = true;

  /** @type {function(...*):?} */
  function _GuiColorBarHue(
  ) {
  abort('missing function: GuiColorBarHue');
  }
  _GuiColorBarHue.stub = true;

  /** @type {function(...*):?} */
  function _GuiColorPanel(
  ) {
  abort('missing function: GuiColorPanel');
  }
  _GuiColorPanel.stub = true;

  /** @type {function(...*):?} */
  function _GuiColorPicker(
  ) {
  abort('missing function: GuiColorPicker');
  }
  _GuiColorPicker.stub = true;

  /** @type {function(...*):?} */
  function _GuiComboBox(
  ) {
  abort('missing function: GuiComboBox');
  }
  _GuiComboBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiDisable(
  ) {
  abort('missing function: GuiDisable');
  }
  _GuiDisable.stub = true;

  /** @type {function(...*):?} */
  function _GuiDrawIcon(
  ) {
  abort('missing function: GuiDrawIcon');
  }
  _GuiDrawIcon.stub = true;

  /** @type {function(...*):?} */
  function _GuiDropdownBox(
  ) {
  abort('missing function: GuiDropdownBox');
  }
  _GuiDropdownBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiDummyRec(
  ) {
  abort('missing function: GuiDummyRec');
  }
  _GuiDummyRec.stub = true;

  /** @type {function(...*):?} */
  function _GuiEnable(
  ) {
  abort('missing function: GuiEnable');
  }
  _GuiEnable.stub = true;

  /** @type {function(...*):?} */
  function _GuiFade(
  ) {
  abort('missing function: GuiFade');
  }
  _GuiFade.stub = true;

  /** @type {function(...*):?} */
  function _GuiGetFont(
  ) {
  abort('missing function: GuiGetFont');
  }
  _GuiGetFont.stub = true;

  /** @type {function(...*):?} */
  function _GuiGetIconData(
  ) {
  abort('missing function: GuiGetIconData');
  }
  _GuiGetIconData.stub = true;

  /** @type {function(...*):?} */
  function _GuiGetIcons(
  ) {
  abort('missing function: GuiGetIcons');
  }
  _GuiGetIcons.stub = true;

  /** @type {function(...*):?} */
  function _GuiGetState(
  ) {
  abort('missing function: GuiGetState');
  }
  _GuiGetState.stub = true;

  /** @type {function(...*):?} */
  function _GuiGetStyle(
  ) {
  abort('missing function: GuiGetStyle');
  }
  _GuiGetStyle.stub = true;

  /** @type {function(...*):?} */
  function _GuiGrid(
  ) {
  abort('missing function: GuiGrid');
  }
  _GuiGrid.stub = true;

  /** @type {function(...*):?} */
  function _GuiGroupBox(
  ) {
  abort('missing function: GuiGroupBox');
  }
  _GuiGroupBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiIconText(
  ) {
  abort('missing function: GuiIconText');
  }
  _GuiIconText.stub = true;

  /** @type {function(...*):?} */
  function _GuiIsLocked(
  ) {
  abort('missing function: GuiIsLocked');
  }
  _GuiIsLocked.stub = true;

  /** @type {function(...*):?} */
  function _GuiLabel(
  ) {
  abort('missing function: GuiLabel');
  }
  _GuiLabel.stub = true;

  /** @type {function(...*):?} */
  function _GuiLabelButton(
  ) {
  abort('missing function: GuiLabelButton');
  }
  _GuiLabelButton.stub = true;

  /** @type {function(...*):?} */
  function _GuiLine(
  ) {
  abort('missing function: GuiLine');
  }
  _GuiLine.stub = true;

  /** @type {function(...*):?} */
  function _GuiListView(
  ) {
  abort('missing function: GuiListView');
  }
  _GuiListView.stub = true;

  /** @type {function(...*):?} */
  function _GuiListViewEx(
  ) {
  abort('missing function: GuiListViewEx');
  }
  _GuiListViewEx.stub = true;

  /** @type {function(...*):?} */
  function _GuiLoadStyle(
  ) {
  abort('missing function: GuiLoadStyle');
  }
  _GuiLoadStyle.stub = true;

  /** @type {function(...*):?} */
  function _GuiLoadStyleDefault(
  ) {
  abort('missing function: GuiLoadStyleDefault');
  }
  _GuiLoadStyleDefault.stub = true;

  /** @type {function(...*):?} */
  function _GuiLock(
  ) {
  abort('missing function: GuiLock');
  }
  _GuiLock.stub = true;

  /** @type {function(...*):?} */
  function _GuiMessageBox(
  ) {
  abort('missing function: GuiMessageBox');
  }
  _GuiMessageBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiPanel(
  ) {
  abort('missing function: GuiPanel');
  }
  _GuiPanel.stub = true;

  /** @type {function(...*):?} */
  function _GuiProgressBar(
  ) {
  abort('missing function: GuiProgressBar');
  }
  _GuiProgressBar.stub = true;

  /** @type {function(...*):?} */
  function _GuiScrollPanel(
  ) {
  abort('missing function: GuiScrollPanel');
  }
  _GuiScrollPanel.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetFont(
  ) {
  abort('missing function: GuiSetFont');
  }
  _GuiSetFont.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetIconData(
  ) {
  abort('missing function: GuiSetIconData');
  }
  _GuiSetIconData.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetIconPixel(
  ) {
  abort('missing function: GuiSetIconPixel');
  }
  _GuiSetIconPixel.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetIconScale(
  ) {
  abort('missing function: GuiSetIconScale');
  }
  _GuiSetIconScale.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetState(
  ) {
  abort('missing function: GuiSetState');
  }
  _GuiSetState.stub = true;

  /** @type {function(...*):?} */
  function _GuiSetStyle(
  ) {
  abort('missing function: GuiSetStyle');
  }
  _GuiSetStyle.stub = true;

  /** @type {function(...*):?} */
  function _GuiSlider(
  ) {
  abort('missing function: GuiSlider');
  }
  _GuiSlider.stub = true;

  /** @type {function(...*):?} */
  function _GuiSliderBar(
  ) {
  abort('missing function: GuiSliderBar');
  }
  _GuiSliderBar.stub = true;

  /** @type {function(...*):?} */
  function _GuiSpinner(
  ) {
  abort('missing function: GuiSpinner');
  }
  _GuiSpinner.stub = true;

  /** @type {function(...*):?} */
  function _GuiStatusBar(
  ) {
  abort('missing function: GuiStatusBar');
  }
  _GuiStatusBar.stub = true;

  /** @type {function(...*):?} */
  function _GuiTextBox(
  ) {
  abort('missing function: GuiTextBox');
  }
  _GuiTextBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiTextBoxMulti(
  ) {
  abort('missing function: GuiTextBoxMulti');
  }
  _GuiTextBoxMulti.stub = true;

  /** @type {function(...*):?} */
  function _GuiTextInputBox(
  ) {
  abort('missing function: GuiTextInputBox');
  }
  _GuiTextInputBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiToggle(
  ) {
  abort('missing function: GuiToggle');
  }
  _GuiToggle.stub = true;

  /** @type {function(...*):?} */
  function _GuiToggleGroup(
  ) {
  abort('missing function: GuiToggleGroup');
  }
  _GuiToggleGroup.stub = true;

  /** @type {function(...*):?} */
  function _GuiUnlock(
  ) {
  abort('missing function: GuiUnlock');
  }
  _GuiUnlock.stub = true;

  /** @type {function(...*):?} */
  function _GuiValueBox(
  ) {
  abort('missing function: GuiValueBox');
  }
  _GuiValueBox.stub = true;

  /** @type {function(...*):?} */
  function _GuiWindowBox(
  ) {
  abort('missing function: GuiWindowBox');
  }
  _GuiWindowBox.stub = true;

  /** @type {function(...*):?} */
  function _InitPhysics(
  ) {
  abort('missing function: InitPhysics');
  }
  _InitPhysics.stub = true;

  /** @type {function(...*):?} */
  function _PhysicsAddForce(
  ) {
  abort('missing function: PhysicsAddForce');
  }
  _PhysicsAddForce.stub = true;

  /** @type {function(...*):?} */
  function _PhysicsAddTorque(
  ) {
  abort('missing function: PhysicsAddTorque');
  }
  _PhysicsAddTorque.stub = true;

  /** @type {function(...*):?} */
  function _PhysicsShatter(
  ) {
  abort('missing function: PhysicsShatter');
  }
  _PhysicsShatter.stub = true;

  /** @type {function(...*):?} */
  function _ResetPhysics(
  ) {
  abort('missing function: ResetPhysics');
  }
  _ResetPhysics.stub = true;

  /** @type {function(...*):?} */
  function _SetPhysicsBodyRotation(
  ) {
  abort('missing function: SetPhysicsBodyRotation');
  }
  _SetPhysicsBodyRotation.stub = true;

  /** @type {function(...*):?} */
  function _SetPhysicsGravity(
  ) {
  abort('missing function: SetPhysicsGravity');
  }
  _SetPhysicsGravity.stub = true;

  /** @type {function(...*):?} */
  function _SetPhysicsTimeStep(
  ) {
  abort('missing function: SetPhysicsTimeStep');
  }
  _SetPhysicsTimeStep.stub = true;

  /** @type {function(...*):?} */
  function _UpdatePhysics(
  ) {
  abort('missing function: UpdatePhysics');
  }
  _UpdatePhysics.stub = true;
  ...
  /** @type {function(...*):?} */
  function _rlCopyShaderBuffer(
  ) {
  abort('missing function: rlCopyShaderBuffer');
  }
  _rlCopyShaderBuffer.stub = true;

  /** @type {function(...*):?} */
  function _rlReadShaderBuffer(
  ) {
  abort('missing function: rlReadShaderBuffer');
  }
  _rlReadShaderBuffer.stub = true;

  /** @type {function(...*):?} */
  function _rlUpdateShaderBuffer(
  ) {
  abort('missing function: rlUpdateShaderBuffer');
  }
  _rlUpdateShaderBuffer.stub = true;

  /** @type {function(...*):?} */
  function _rresComputeCRC32(
  ) {
  abort('missing function: rresComputeCRC32');
  }
  _rresComputeCRC32.stub = true;

  /** @type {function(...*):?} */
  function _rresGetCipherPassword(
  ) {
  abort('missing function: rresGetCipherPassword');
  }
  _rresGetCipherPassword.stub = true;

  /** @type {function(...*):?} */
  function _rresGetDataType(
  ) {
  abort('missing function: rresGetDataType');
  }
  _rresGetDataType.stub = true;

  /** @type {function(...*):?} */
  function _rresGetResourceId(
  ) {
  abort('missing function: rresGetResourceId');
  }
  _rresGetResourceId.stub = true;

  /** @type {function(...*):?} */
  function _rresLoadCentralDirectory(
  ) {
  abort('missing function: rresLoadCentralDirectory');
  }
  _rresLoadCentralDirectory.stub = true;

  /** @type {function(...*):?} */
  function _rresLoadResourceChunk(
  ) {
  abort('missing function: rresLoadResourceChunk');
  }
  _rresLoadResourceChunk.stub = true;

  /** @type {function(...*):?} */
  function _rresLoadResourceChunkInfo(
  ) {
  abort('missing function: rresLoadResourceChunkInfo');
  }
  _rresLoadResourceChunkInfo.stub = true;

  /** @type {function(...*):?} */
  function _rresLoadResourceChunkInfoAll(
  ) {
  abort('missing function: rresLoadResourceChunkInfoAll');
  }
  _rresLoadResourceChunkInfoAll.stub = true;

  /** @type {function(...*):?} */
  function _rresLoadResourceMulti(
  ) {
  abort('missing function: rresLoadResourceMulti');
  }
  _rresLoadResourceMulti.stub = true;

  /** @type {function(...*):?} */
  function _rresSetCipherPassword(
  ) {
  abort('missing function: rresSetCipherPassword');
  }
  _rresSetCipherPassword.stub = true;

  /** @type {function(...*):?} */
  function _rresUnloadCentralDirectory(
  ) {
  abort('missing function: rresUnloadCentralDirectory');
  }
  _rresUnloadCentralDirectory.stub = true;

  /** @type {function(...*):?} */
  function _rresUnloadResourceChunk(
  ) {
  abort('missing function: rresUnloadResourceChunk');
  }
  _rresUnloadResourceChunk.stub = true;

  /** @type {function(...*):?} */
  function _rresUnloadResourceMulti(
  ) {
  abort('missing function: rresUnloadResourceMulti');
  }
  _rresUnloadResourceMulti.stub = true;
...
var wasmImports = {
  /** @export */
  CheckCollisionPointPoly: _CheckCollisionPointPoly,
  /** @export */
  ClosePhysics: _ClosePhysics,
  /** @export */
  CreatePhysicsBodyCircle: _CreatePhysicsBodyCircle,
  /** @export */
  CreatePhysicsBodyPolygon: _CreatePhysicsBodyPolygon,
  /** @export */
  CreatePhysicsBodyRectangle: _CreatePhysicsBodyRectangle,
  /** @export */
  DestroyPhysicsBody: _DestroyPhysicsBody,
  /** @export */
  GenImagePerlinNoise: _GenImagePerlinNoise,
  /** @export */
  GetPhysicsBodiesCount: _GetPhysicsBodiesCount,
  /** @export */
  GetPhysicsBody: _GetPhysicsBody,
  /** @export */
  GetPhysicsShapeType: _GetPhysicsShapeType,
  /** @export */
  GetPhysicsShapeVertex: _GetPhysicsShapeVertex,
  /** @export */
  GetPhysicsShapeVerticesCount: _GetPhysicsShapeVerticesCount,
  /** @export */
  GuiButton: _GuiButton,
  /** @export */
  GuiCheckBox: _GuiCheckBox,
  /** @export */
  GuiCheckIconPixel: _GuiCheckIconPixel,
  /** @export */
  GuiClearIconPixel: _GuiClearIconPixel,
  /** @export */
  GuiColorBarAlpha: _GuiColorBarAlpha,
  /** @export */
  GuiColorBarHue: _GuiColorBarHue,
  /** @export */
  GuiColorPanel: _GuiColorPanel,
  /** @export */
  GuiColorPicker: _GuiColorPicker,
  /** @export */
  GuiComboBox: _GuiComboBox,
  /** @export */
  GuiDisable: _GuiDisable,
  /** @export */
  GuiDrawIcon: _GuiDrawIcon,
  /** @export */
  GuiDropdownBox: _GuiDropdownBox,
  /** @export */
  GuiDummyRec: _GuiDummyRec,
  /** @export */
  GuiEnable: _GuiEnable,
  /** @export */
  GuiFade: _GuiFade,
  /** @export */
  GuiGetFont: _GuiGetFont,
  /** @export */
  GuiGetIconData: _GuiGetIconData,
  /** @export */
  GuiGetIcons: _GuiGetIcons,
  /** @export */
  GuiGetState: _GuiGetState,
  /** @export */
  GuiGetStyle: _GuiGetStyle,
  /** @export */
  GuiGrid: _GuiGrid,
  /** @export */
  GuiGroupBox: _GuiGroupBox,
  /** @export */
  GuiIconText: _GuiIconText,
  /** @export */
  GuiIsLocked: _GuiIsLocked,
  /** @export */
  GuiLabel: _GuiLabel,
  /** @export */
  GuiLabelButton: _GuiLabelButton,
  /** @export */
  GuiLine: _GuiLine,
  /** @export */
  GuiListView: _GuiListView,
  /** @export */
  GuiListViewEx: _GuiListViewEx,
  /** @export */
  GuiLoadStyle: _GuiLoadStyle,
  /** @export */
  GuiLoadStyleDefault: _GuiLoadStyleDefault,
  /** @export */
  GuiLock: _GuiLock,
  /** @export */
  GuiMessageBox: _GuiMessageBox,
  /** @export */
  GuiPanel: _GuiPanel,
  /** @export */
  GuiProgressBar: _GuiProgressBar,
  /** @export */
  GuiScrollPanel: _GuiScrollPanel,
  /** @export */
  GuiSetFont: _GuiSetFont,
  /** @export */
  GuiSetIconData: _GuiSetIconData,
  /** @export */
  GuiSetIconPixel: _GuiSetIconPixel,
  /** @export */
  GuiSetIconScale: _GuiSetIconScale,
  /** @export */
  GuiSetState: _GuiSetState,
  /** @export */
  GuiSetStyle: _GuiSetStyle,
  /** @export */
  GuiSlider: _GuiSlider,
  /** @export */
  GuiSliderBar: _GuiSliderBar,
  /** @export */
  GuiSpinner: _GuiSpinner,
  /** @export */
  GuiStatusBar: _GuiStatusBar,
  /** @export */
  GuiTextBox: _GuiTextBox,
  /** @export */
  GuiTextBoxMulti: _GuiTextBoxMulti,
  /** @export */
  GuiTextInputBox: _GuiTextInputBox,
  /** @export */
  GuiToggle: _GuiToggle,
  /** @export */
  GuiToggleGroup: _GuiToggleGroup,
  /** @export */
  GuiUnlock: _GuiUnlock,
  /** @export */
  GuiValueBox: _GuiValueBox,
  /** @export */
  GuiWindowBox: _GuiWindowBox,
  /** @export */
  InitPhysics: _InitPhysics,
  /** @export */
  PhysicsAddForce: _PhysicsAddForce,
  /** @export */
  PhysicsAddTorque: _PhysicsAddTorque,
  /** @export */
  PhysicsShatter: _PhysicsShatter,
  /** @export */
  ResetPhysics: _ResetPhysics,
  /** @export */
  SetPhysicsBodyRotation: _SetPhysicsBodyRotation,
  /** @export */
  SetPhysicsGravity: _SetPhysicsGravity,
  /** @export */
  SetPhysicsTimeStep: _SetPhysicsTimeStep,
  /** @export */
  UpdatePhysics: _UpdatePhysics,
  /** @export */
  ...
  /** @export */
  rlCopyShaderBuffer: _rlCopyShaderBuffer,
  /** @export */
  rlReadShaderBuffer: _rlReadShaderBuffer,
  /** @export */
  rlUpdateShaderBuffer: _rlUpdateShaderBuffer,
  /** @export */
  rresComputeCRC32: _rresComputeCRC32,
  /** @export */
  rresGetCipherPassword: _rresGetCipherPassword,
  /** @export */
  rresGetDataType: _rresGetDataType,
  /** @export */
  rresGetResourceId: _rresGetResourceId,
  /** @export */
  rresLoadCentralDirectory: _rresLoadCentralDirectory,
  /** @export */
  rresLoadResourceChunk: _rresLoadResourceChunk,
  /** @export */
  rresLoadResourceChunkInfo: _rresLoadResourceChunkInfo,
  /** @export */
  rresLoadResourceChunkInfoAll: _rresLoadResourceChunkInfoAll,
  /** @export */
  rresLoadResourceMulti: _rresLoadResourceMulti,
  /** @export */
  rresSetCipherPassword: _rresSetCipherPassword,
  /** @export */
  rresUnloadCentralDirectory: _rresUnloadCentralDirectory,
  /** @export */
  rresUnloadResourceChunk: _rresUnloadResourceChunk,
  /** @export */
  rresUnloadResourceMulti: _rresUnloadResourceMulti,
  /** @export */
...
var ___start_em_js = Module['___start_em_js'] = 924652;
var ___stop_em_js = Module['___stop_em_js'] = 924727;
